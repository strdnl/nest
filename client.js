...
async function createPeerConnection() {
  ...
  // STUN server.
const config = {iceServers: [{url: 'turn:turn.anyfirewall.com:443?transport=tcp',
    credential: 'webrtc',
    username: 'webrtc'}]};
  myPeerConnection = new RTCPeerConnection(config);
  //sendChannel = myPeerConnection.createDataChannel("chat", {negotiated: true, id: 0});
  // sendChannel.onopen = handleSendChannelStatusChange;
  //  sendChannel.onclose = handleSendChannelStatusChange;
 // log(sendChannel.readyState)
  //const offerr =  myPeerConnection.createOffer();
  //log(offerr);
 //const logger = myPeerConnection.setLocalDescription(offerr)
...
log(sendChannel.readyState);
  sendChannel.send("hello").catch(reportError);
